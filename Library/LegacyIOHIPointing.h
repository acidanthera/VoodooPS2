...
public:
  ...
  virtual void close(IOService * client, IOOptionBits ) override;
  virtual IOReturn message( UInt32 type, IOService * provider,
                              void * argument = 0 ) override;

  virtual IOHIDKind hidKind() override;
  virtual bool 	    updateProperties( void ) override;
  ...
  virtual IOReturn  powerStateWillChangeTo( IOPMPowerFlags powerFlags,
                        unsigned long newState, IOService * device) override;
